...
if __name__ == '__main__':
    ...
    input_iterator = graph.get_tensor_by_name('prefix/Input_Data/Iterator:0')
    input_getnext = graph.get_tensor_by_name('prefix/Input_Data/IteratorGetNext:0')
    input_istraining = graph.get_tensor_by_name('prefix/Is_training:0')
    predictions = graph.get_tensor_by_name('prefix/prediction:0')
    probs = graph.get_tensor_by_name('prefix/probs:0')